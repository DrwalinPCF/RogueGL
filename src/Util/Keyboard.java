...
public class Keyboard
{
	...
	public static final int KEY_RALT = GLFW.GLFW_KEY_RIGHT_ALT;
	...
	public static final int KEY_CAPSLOCK = GLFW.GLFW_KEY_CAPS_LOCK;
	
	// public static final int KEY_TILD = GLFW.GLFW_KEY_?;
	...
	// public static final int KEY_DOT = GLFW.GLFW_KEY_?;
	...
	public static final int KEY_PGUP = GLFW.GLFW_KEY_PAGE_UP;
	public static final int KEY_PGDN = GLFW.GLFW_KEY_PAGE_DOWN;
	...
	public static final int KEY_KP_DOT = GLFW.GLFW_KEY_KP_DECIMAL;
	public static final int KEY_KP_ADD = GLFW.GLFW_KEY_KP_ADD;
	public static final int KEY_KP_DIV = GLFW.GLFW_KEY_KP_DIVIDE;
	public static final int KEY_KP_SUB = GLFW.GLFW_KEY_KP_SUBTRACT;
	public static final int KEY_KP_MUL = GLFW.GLFW_KEY_KP_MULTIPLY;
